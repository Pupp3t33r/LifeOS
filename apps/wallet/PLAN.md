...
- **Offline-first** — pending ADR `apps/wallet/docs/adr/0001-offline-first-sync.md`. The base decision lives in AGENTS.md (read models + outbox + idempotency) but is **not yet frozen**. The period-flows cache slice (2026-06-30) surfaced concrete choices the ADR must weigh:
